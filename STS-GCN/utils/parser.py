...
parser.add_argument('--model_path',type=str,default='./checkpoints/CKPT_3D_H36M/h36_ang_10_2frames_ckpt',help= 'directory with the models checkpoints ')
parser.add_argument('--action', type=str, default="smoking", help='Choose which actions to complete')
