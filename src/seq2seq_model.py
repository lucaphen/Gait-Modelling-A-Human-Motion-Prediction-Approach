...
class Seq2SeqModel(object):
  ...
  def __init__(self,
    ...
    with tf.name_scope("inputs"):
      ...
      enc_in = tf.placeholder(dtype, shape=[None, source_seq_len-1, self.input_size], name="enc_in")  # encoder input
      dec_in = tf.placeholder(dtype, shape=[None, target_seq_len, self.input_size], name="dec_in")    # ecoder output/decoder input
      dec_out = tf.placeholder(dtype, shape=[None, target_seq_len, self.input_size], name="dec_out")  # decoder output
